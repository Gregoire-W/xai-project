...
import base64
import numpy as np
from .utils import make_gradcam_heatmap, get_gradcam_superimposed
import importlib

class ImageXAIService:
    ...
    def _explain_with_gradcam(self, grad_model, preprocessing_import, image,):
        ...
        superimposed_img = get_gradcam_superimposed(image_array, heatmap)
...
image_xai_service = ImageXAIService()